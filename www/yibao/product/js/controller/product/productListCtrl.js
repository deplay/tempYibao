...
})}loadData();$scope.style={one:false,price:false,reviews:false};var tabs=[{tag:"综合",sort:"relevance"},{tag:"热搜",sort:"topRated"},{tag:"销量",sort:"saleAmount"},{tag:"价格从低到高",sort:"price-asc"},{tag:"价格从高到低",sort:"price-desc"},{tag:"评价从低到高",sort:"reviews-asc"},{tag:"评价从高到低",sort:"reviews-desc"}];
