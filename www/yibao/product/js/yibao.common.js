...
return fullUrl}}]);yibaoCommon.directive("myLoading",function(){return{restrict:"E",replace:true,template:'<div class="myloading" ng-show="loading"><div class="loading-center"><div class="loading-center-absolute"><li class="ion-heart"></li></div></div></div>'}
